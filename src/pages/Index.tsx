...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] selection:bg-[#D4AF37] selection:text-black overflow-x-hidden max-w-full">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-16">
              {[
                ...
                >
                  <div className="text-4xl md:text-5xl font-serif italic text-[#D4AF37] mb-3">{stat.value}</div>
                  <div className="text-[10px] text-gray-500 uppercase tracking-[0.4em] font-bold">{stat.label}</div>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-24">
              ...
              <div className="md:w-1/2 relative">
                <div className="relative z-10 border border-white/10 p-4 glass-premium">
                  <img 
      ...
      <footer className="bg-[#050505] text-white py-32 px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-24">
          <div className="col-span-2">
            <div className="text-2xl font-light tracking-[0.5em] uppercase mb-10">
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#D4AF37] mb-10">Navigation</h4>
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#D4AF37] mb-10">Social</h4>
            <ul className="space-y-6 text-gray-500 text-[10px] font-bold uppercase tracking-[0.3em]">
        ...
        <div className="max-w-7xl mx-auto mt-32 pt-12 border-t border-white/5 text-center text-gray-600 text-[10px] font-bold uppercase tracking-[0.4em]">
