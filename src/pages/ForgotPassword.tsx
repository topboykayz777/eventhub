  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <div className="max-w-lg mx-auto mt-20 px-6">
        ...
        >
          <div className="mb-8">
            <Link to="/login" className="text-[10px] font-bold uppercase tracking-widest text-gray-500 hover:text-[#D4AF37] flex items-center gap-2 transition-colors">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm font-light tracking-wide">Enter your email to receive a secure reset link.</p>
          </div>
