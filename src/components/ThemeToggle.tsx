...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="rounded-full w-10 h-10 border border-white/10 dark:border-white/10 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 transition-colors"
    >
