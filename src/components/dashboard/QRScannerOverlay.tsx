        ...
        >
          <div className="p-6 md:p-8 flex items-center justify-between border-b border-white/5 bg-black/40">
            <Button 
              variant="ghost" 
              onClick={onClose}
              className="text-gray-400 hover:text-white rounded-full h-12 px-6"
            >
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-12 flex flex-col items-center">
            <div className="max-w-md w-full space-y-12">
              <div className="text-center">
                ...
                <p className="text-[9px] text-gray-500 font-bold uppercase tracking-[0.3em]">Align the QR pass within the frame</p>
              </div>
              ...
              <div className="pt-8 border-t border-white/5 text-center">
                <p className="text-[8px] font-black uppercase tracking-[0.4em] text-gray-600 mb-6">Manual Override</p>
                <div className="flex gap-4">
                  <Input 
                    placeholder="Enter Pass ID" 
                    className="bg-white/5 border-white/10 rounded-none h-16 text-lg font-light placeholder:text-gray-800"
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
