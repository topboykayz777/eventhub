    ...
    <div className="w-full max-w-sm md:max-w-none">
      <div className="relative aspect-[4/5] w-full overflow-hidden border border-border group rounded-[2.5rem] md:rounded-[3rem] bg-black shadow-lg">
        ...
        <div className="absolute bottom-8 left-8 right-8 text-center md:text-left">
          <h2 className="text-2xl md:text-3xl font-serif italic text-white mb-4 line-clamp-2 leading-tight">{event.event_name}</h2>
          <div className="flex flex-col items-center md:items-start gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-white/70">
            ...
            <div className="flex items-center gap-2 max-w-full"><MapPin className="w-3 h-3 text-[#D4AF37] shrink-0" /> <span className="truncate">{event.venue}</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 flex flex-col gap-4 px-4 md:px-0">
        <div className="relative">
          <Button 
            ...
            className="w-full rounded-2xl border-border bg-card text-foreground text-[10px] font-bold uppercase tracking-[0.2em] py-6 h-auto hover:bg-muted transition-all group pr-12"
          >
            <Edit className="w-3 h-3 mr-2 shrink-0 opacity-60 group-hover:opacity-100" /> Edit Event Page
          </Button>
          <div className="absolute right-4 top-1/2 -translate-y-1/2"><InfoButton text="Refine your event's digital presence. Update the title, date, and venue, or refresh your visual gallery with new cinematic portraits and captured moments." /></div>
        </div>
        ...
        <div className="relative">
          <Button 
            ...
            className="w-full rounded-2xl border-[#D4AF37]/30 bg-[#D4AF37]/5 text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.2em] py-6 h-auto hover:bg-[#D4AF37]/10 pr-12"
          >
            <ExternalLink className="w-3 h-3 mr-2 shrink-0" /> Check Event Page
          </Button>
          <div className="absolute right-4 top-1/2 -translate-y-1/2"><InfoButton text="Experience your event link exactly as your guests will. Preview the live animations, registration flows, and overall digital aesthetic." /></div>
        </div>
        ...
        <div className="relative">
          <Button 
            ...
            className={`w-full rounded-2xl py-6 h-auto text-[10px] font-bold uppercase tracking-[0.4em] transition-all pr-12 ${
              isFinished 
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2"><InfoButton text={isFinished ? "Bring your event back to life. This will reactivate the guest registry and restore all live features." : "Officially finalize your celebration to lock the guest registry and archive the experience."} /></div>
        </div>
      </div>
    </div>
  );
