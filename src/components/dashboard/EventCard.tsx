      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden border border-border group rounded-[2.5rem] md:rounded-[3rem] bg-black shadow-lg">
        ...
        <div className="absolute bottom-8 left-8 right-8 text-center md:text-left">
          ...
          <div className="flex flex-col items-center md:items-start gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-white/70">
            ...
            <div className="flex items-center gap-2"><MapPin className="w-3 h-3 text-[#D4AF37] shrink-0" /> <span className="truncate max-w-[200px]">{event.venue}</span></div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 flex flex-col gap-4 w-full px-2">
        <div className="relative w-full flex items-center justify-center">
          <Button 
            ...
            className="w-full rounded-2xl border-border bg-card text-foreground text-[10px] font-bold uppercase tracking-[0.2em] py-6 h-auto hover:bg-muted transition-all group flex items-center justify-center gap-2 pr-10"
          >
            <Edit className="w-3 h-3 shrink-0 opacity-60 group-hover:opacity-100" /> Edit Event Page
          </Button>
        ...
        <div className="relative w-full flex items-center justify-center">
          <Button 
            ...
            className="w-full rounded-2xl border-[#D4AF37]/30 bg-[#D4AF37]/5 text-[#D4AF37] text-[10px] font-bold uppercase tracking-[0.2em] py-6 h-auto hover:bg-[#D4AF37]/10 flex items-center justify-center gap-2 pr-10"
          >
            <ExternalLink className="w-3 h-3 shrink-0" /> Check Event Page
          </Button>
        ...
        <div className="relative w-full flex items-center justify-center">
          <Button 
            ...
            className={`w-full rounded-2xl py-6 h-auto text-[10px] font-bold uppercase tracking-[0.4em] transition-all flex items-center justify-center gap-2 pr-10 ${
              isFinished 
