        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-base md:text-lg font-light opacity-70">{event.event_name}</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-full bg-[#D4AF37]/10 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-base md:text-lg font-light opacity-70">{event.event_date.slice(0, 16)}</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-full bg-[#D4AF37]/10 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-base md:text-lg font-light opacity-70">{event.venue}</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-full bg-[#D4AF37]/10 flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-sm md:text-base font-light opacity-70">{event.message}</p>
            </div>
          </div>
          <div className="mt-4">
            <Button 
